...
#read in data
mtdna_papers_new <- read.csv("Datasets/mtdna_assembled_new.csv", stringsAsFactors = FALSE) #read in collected mtDNA data
msat_papers_new <- read.csv("Datasets/msatloci.csv", stringsAsFactors = FALSE) #read in collected msat data
