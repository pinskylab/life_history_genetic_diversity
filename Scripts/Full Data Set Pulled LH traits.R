...
#pulls life history traits for both mtdna & msat species (full data)
...
#read in data
msat_spp <- read.csv("msatloci.csv", stringsAsFactors = FALSE) #read in mtdna species list for new 
mtdna_spp <- read.csv("mtdna_assembled_new.csv", stringsAsFactors = FALSE) #read in msat species list
