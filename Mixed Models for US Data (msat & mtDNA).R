...
fit.bin <- glmer(mtdnas.or.f ~ spp + (1|He), family=binomial, data=mtdna_data)

fit.bin <- glmer(mtdnas.or.f ~ spp + (1|maxlength), family=binomial, data=mtdna_data)
...
nBoot <- 1000
lrStat <- rep(NA,nBoot)
ft.null <- glmer(mtdnas.or.f ~ 1 + (1|maxlength) ,family=binomial, data=mtdna_data) #null model
ft.alt <- glmer(mtdnas.or.f ~ spp + (1|maxlength) ,family=binomial, data=mtdna_data) #alternate model
...
fit.bin <- glmer(msats.or.f ~ CrossSpp + (1|maxlength), family=binomial, data=msat_data)

fit.bin <- glmer(msats.or.f ~ spp + (1|maxlength), family=binomial, data=msat_data)
